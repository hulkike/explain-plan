-- DISEÑO UNO A MUCHOS NO IDENTIFICABLE CON LLAVES SUBROGADAS SIN INDICES UNICOS
-- explain plan 2 query 1
-- enlace: https://explain.depesz.com/s/MHZK
-- costo: 2187 de 100000 registros
...
-- DISEÑO UNO A MUCHOS NO IDENTIFICABLE CON LLAVES SUBROGADAS SIN INDICES UNICOS WHERE A CAMPO NO IDEXADO
...
-- costo: 2175.06 de 100000 registros
explain (analyse true, costs true, timing true, buffers true, verbose true)
select count(*)
from ex2_cliente;
...
-- costo: 13217.23 de 100000 registros
explain (analyse true, costs true, timing true, buffers true, verbose true)
select *
from ex2_cliente c
...
-- costo: 5616.59 de 100000 registros
explain (analyse true, costs true, timing true, buffers true, verbose true)
...
-- costo: 2187.06 de 100000 registros
explain (analyse true, costs true, timing true, buffers true, verbose true)
select td.nombre, c.numero_documento, c.nombres, c.apellidos
from ex2_cliente c,
